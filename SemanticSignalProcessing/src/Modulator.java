...
public class Modulator extends JDialog implements ActionListener {
  ...
  public Modulator(JFrame frame, SSP_Main parent) {
    super(frame, true);
    ...
    b1.add(new JLabel("Modulator configuration"));
    b1.add(Box.createGlue());
    
    t1 = new JTextArea("Please check any of the following options \n(i.e., BPSK, QPSK, 8PSK and 16QAM) as \nyour desired modulation scheme.");    
    
    Box b2 = Box.createVerticalBox();
	b2.add(Box.createGlue());
    b2.add(new JLabel("Options:"));
    b2.add(Box.createGlue());
   
    radioGroup = new CheckboxGroup(); 
    radio1 = new Checkbox("BPSK", radioGroup,true); 
    radio2 = new Checkbox("QPSK", radioGroup,false); 
    radio3 = new Checkbox("8PSK", radioGroup,false); 
    radio4 = new Checkbox("16QAM", radioGroup,false); 
