...
public class AWGNChannel extends JDialog implements ActionListener {
  ...
  public AWGNChannel(JFrame frame, SSP_Main parent) {
    super(frame, true);
  ...
  public void actionPerformed(ActionEvent evt)
  {
	  ...
	  {	
		  if (t2.getText().isEmpty())
			  p.NodeInformationRecord[p.FlagSelected].AWGNVariance = 1;
		  else
			  p.NodeInformationRecord[p.FlagSelected].AWGNVariance = Integer.parseInt(t2.getText().toString());
